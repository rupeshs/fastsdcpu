...
class ControlNetWidget(QWidget):
    def __init__(self, config: AppSettings, parent):
        ...
        self.model_label = QLabel("ControlNet model:")
        self.model_label.setEnabled(False)
        self.model_scale = QLabel("Conditioning scale:")
        self.model_scale.setEnabled(False)
        self.cimage_label = QLabel("Control image:")
        self.cimage_label.setEnabled(False)
        self.separator = QLabel()
        self.separator.setFrameShape(QFrame.HLine)
        hlayout = QGridLayout()
        hlayout.addWidget(self.model_label, 0, 0)
        hlayout.addWidget(self.model_scale, 0, 1)
        hlayout.addWidget(self.cimage_label, 0, 2)
    ...
    def on_enable_changed(self, state: int):
        ...
        self.model_label.setEnabled(_current_controlnet_enabled)
        self.model_scale.setEnabled(_current_controlnet_enabled)
        self.cimage_label.setEnabled(_current_controlnet_enabled)
        self.update_controlnet_settings()
